...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var num4 = multiply(c, num3)[0];

  var str1 = `${a} and ${b} and ${c} sum to ${num2}.`;
  var str2 = `The product of ${a} and ${b} and ${c} is ${num4}.`;
  // console.log([num2, num4, str1, str2]);

  return [num2, num4, str1, str2];
}
...
function multiplyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    multiply(product, dynamicArray[i])[0];
  }
...
testMultiplyArray(testDynamicArray);
